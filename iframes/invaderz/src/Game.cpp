...
Game::Game(SDL2Wrapper::Window &windowA)
		: shouldDrawMenu(true), shouldExit(false), shouldPlayHiscoreSound(false), score(0), lastScore(0), window(windowA), playerMayFire(true), enemyFireRate(GameOptions::enemyFireRate)
{
...
{
	playerShip->set(GameOptions::width / 2, GameOptions::height - GameOptions::spriteSize * 2);
